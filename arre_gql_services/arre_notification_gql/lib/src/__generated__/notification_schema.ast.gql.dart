...
const NotificationResponse = _i1.ObjectTypeDefinitionNode(
  name: _i1.NameNode(value: 'NotificationResponse'),
  directives: [],
  interfaces: [],
  fields: [
    _i1.FieldDefinitionNode(
...
const inputDeviceInfo = _i1.InputObjectTypeDefinitionNode(
...
const lastAppLandingSourceType = _i1.EnumTypeDefinitionNode(
...
const schemaName = _i1.EnumTypeDefinitionNode(
  name: _i1.NameNode(value: 'schemaName'),
  directives: [],
  values: [
    _i1.EnumValueDefinitionNode(
      name: _i1.NameNode(value: 'TransactionalNotification'),
      directives: [],
    ),
    _i1.EnumValueDefinitionNode(
      name: _i1.NameNode(value: 'SocialNotification'),
      directives: [],
    ),
    _i1.EnumValueDefinitionNode(
      name: _i1.NameNode(value: 'CMSNotification'),
      directives: [],
    ),
  ],
);
