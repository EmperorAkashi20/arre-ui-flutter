...
def _check_cocoapods_for_GetSocial(latest_version, version_to_use):
	...
	if os.path.isdir(podsFolderPath):
		...
		extendedV2FrameworkPath = __projectFolderPath + 'Pods/GetSocialExtendedV2/GetSocialExtended/GetSocialSDK.xcframework'
		if not os.path.exists(frameworkPath) and not os.path.exists(extendedFrameworkPath) and not os.path.exists(extendedV2FrameworkPath):
